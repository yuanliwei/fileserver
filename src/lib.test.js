...
test('cleanFilename', async () => {
    ...
    strictEqual(name, '【含老师手打分】成都都都（天天天天）-2025级11班-应应应-应应应应：应应应应应应应-5B20443D8A4AC67FD661841...c28cd4be1ec9bf5-分项评分-(20251105-1)-分分分分-[初中-应应应-应应]-(20251105-3).xlsx')
    strictEqual(cleanFilename(name), '【含老师手打分】成都都都（天天天天）-2025级11班-应应应-应应应应：应应应应应应应-5B20443D8A4AC67FD661841...c28cd4be1ec9bf5-分项评分-(20251105-1)-分分分分-[初中-应应应-应应]-(20251105-3).xlsx')
})